            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ action('ApartmentsController@update', $id) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text" class="form-control" name="address" value="{{$address}}" autofocus>
                                </div>
                            </div>
